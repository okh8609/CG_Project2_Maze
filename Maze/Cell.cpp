...
// * Constructor.
//=======================================================================
Cell::Cell(int i, Edge *px, Edge *py, Edge *mx, Edge *my)
{
	index = i;
...
//=======================================================================
bool Cell::Point_In_Cell(const float x, const float y, const float z, Cell* &neighbor)
{
	int i;
...
//=======================================================================
Cell* Cell::Clip_To_Cell(float &xs, float &ys, float &xe, float &ye, const float buffer)
	//=======================================================================
{
